[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=ryan-snyder_dnd-project-temp&metric=alert_status)](https://sonarcloud.io/dashboard?id=ryan-snyder_dnd-project-temp)
